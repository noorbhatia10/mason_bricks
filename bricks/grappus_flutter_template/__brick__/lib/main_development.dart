...
Future<void> main() async {
  ...
  Keys.baseUrl = DevConstants.backendBaseUrl;
  Keys.baseAuthUrl = DevConstants.baseAuthUrl;
  Keys.authClientId = DevConstants.authClientId;
  NavKey().showApiDebugger = true;
